...
export default function HeroSection() {
  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      ...
      const x = (e.clientX / innerWidth - 0.5) * 80; // Increased sensitivity
      const y = (e.clientY / innerHeight - 0.5) * 80; // Increased sensitivity
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center h-screen px-10 md:px-20 bg-gradient-to-br from-black via-gray-900 to-black text-white overflow-hidden">
      ...
      <div className="md:w-1/2 text-center  md:text-left ">
        <h1 className="sm:mt-24   sm:mt-0 text-6xl md:text-8xl font-extrabold leading-tight ">
          <SplitText
            text="HI, I'M"
            className=" sm:mt-0 text-6xl md:text-8xl font-extrabold leading-tight"
            delay={100}
            duration={0.6}
            ease="power3.out"
            splitType="chars"
